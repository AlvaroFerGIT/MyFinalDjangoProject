...
class Manga(models.Model):
    ...
    image = models.ImageField(upload_to = 'img', help_text="Image of the Manga")
...
class Author(models.Model):
    ...
    alias = models.CharField(max_length= 50, help_text="Alias of the author, optional", blank=True, default="")
    author_image = models.ImageField(upload_to = 'img', help_text="Image of the Author",blank=True, default="")
